...
static sgx_status_t SGX_CDECL sgx_ecall_count(void* pms)
{
	ms_ecall_count_t* ms = SGX_CAST(ms_ecall_count_t*, pms);
	sgx_status_t status = SGX_SUCCESS;

	CHECK_REF_POINTER(pms, sizeof(ms_ecall_count_t));
...
SGX_EXTERNC const struct {
	...
	3,
	{
		...
		{(void*)(uintptr_t)sgx_ecall_count, 0},
	}
};
